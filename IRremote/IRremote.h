...
public:
    ...
    uint64_t value;             ///< Decoded value [max 64-bits] - the 64 bits are needed for the electra code which is 34 bits
...
private:
    ...
    bool decodeElectra(decode_results *results);
#endif
